...
// import avatar from "../src/assets/comment-3-svgrepo-com.svg"
...
//   return (
//    <article className="mb-4 break-inside p-6 rounded-xl  overflow-hidden  shadow-2xl bg-gray-100 dark:bg-slate-800 flex flex-col bg-clip-border w-full">

//           {/* post header */}
//   <div className="flex pb-6 items-center justify-between">
//     <div className="flex">
//       <a className="inline-block mr-4" href="#">
//         <img className="rounded-full max-w-none  object-cover w-12 h-12" src={post.user.photo} />
//       </a>
...
//         {/* <img onError={(e)=>e.target.src= avatar} className="rounded-full max-w-none w-12 h-12" src="https://randomuser.me/api/portraits/men/82.jp" /> */}
//       </a>
...
//    {/* {
//                                             //  في حالة لو في كومنت ففي اراي اعمل عليه ولو مفيش صورة حملي المسار التاني اللي انا مسجله مثلا في commenticon
//     post.comments.slice(0,commentlimit).map((comment)=>{
//       return  <div className="media flex pb-4">
//       <a className="mr-4" href="#">
//         <img onError={(e)=>e.target.src = commentIcon} className="rounded-full max-w-none w-12 h-12" src="https://randomuser.me/api/portraits/men/82.jpg" />
//       </a>
//       <div className="media-body">
//         <div>
//           <a className="inline-block text-base font-bold mr-2" href="#">Leslie Alexander</a>
...
//       <Link to={`/posts/${post._id}`} className="py-3 px-4 w-full block bg-slate-300 dark:bg-slate-700 text-center rounded-lg font-medium hover:bg-slate-200 dark:hover:bg-slate-600 transition ease-in-out delay-75">Show
//         more comments</Link>
//     </div>


//                                         {/* اللينك ده لو في array of comment علشان هيخفي الزرارا بتاع show more details */}
//     {/* <div className="w-full">
//      { commentlimit != undefined && <Link to={`/posts/${post._id}`} className="py-3 px-4 w-full block bg-slate-300 dark:bg-slate-700 text-center rounded-lg font-medium hover:bg-slate-200 dark:hover:bg-slate-600 transition ease-in-out delay-75">Show
//         more comments</Link>
//      }
//     </div> */}
//   </div>
